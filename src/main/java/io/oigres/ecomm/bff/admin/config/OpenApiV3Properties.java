...
public class OpenApiV3Properties {
  ...
  public static class BFFProperties {
    @NotNull private AdminBFFProperties admin;
  }

  @NotNull @NotBlank private String termsOfService;
  @NotNull @NotBlank private String license;
  @NotNull private BFFProperties bff;
}
