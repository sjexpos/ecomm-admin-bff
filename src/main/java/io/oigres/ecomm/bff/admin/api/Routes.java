...
public class Routes {
    ...
    public static final String ACTIVATE_DISPENSARY_USER_BY_DISPENSARY_USER_ID = "/dispensaries/{userId}/activate";
    public static final String DEACTIVATE_DISPENSARY_USER_BY_DISPENSARY_USER_ID = "/dispensaries/{userId}/deactivate";
    ...
    public static final String DEACTIVATE_CATALOG_PRODUCT_BY_ID = "/catalog/{catalogProductId}/deactivate";
    public static final String ACTIVATE_CATALOG_PRODUCT_BY_ID = "/catalog/{catalogProductId}/activate";
